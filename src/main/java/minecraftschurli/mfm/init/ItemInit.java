...
public class ItemInit {
	...
	public static final ArmorMaterial ARMOR_VULCANIUM = EnumHelper.addArmorMaterial("armor_vulcanium", Reference.MODID + ":vulcanium", 40, new int[]{3,6,8,3}, 30, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F);
