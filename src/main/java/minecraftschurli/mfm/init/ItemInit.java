...
public class ItemInit {
    ...
    */
    ...
    public static final Item AXE_VULCANIUM = new AxeBase("axe_vulcanium", VULCANIUM.getTOOL_MATERIAL(), 10F, 0F);
    public static final Item SHOVEL_VULCANIUM = new ShovelBase("shovel_vulcanium", VULCANIUM.getTOOL_MATERIAL());
    public static final Item PICKAXE_VULCANIUM = new PickaxeBase("pickaxe_vulcanium", VULCANIUM.getTOOL_MATERIAL());
    //Armor
