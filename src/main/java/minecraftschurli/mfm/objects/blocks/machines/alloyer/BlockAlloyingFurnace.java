...
public class BlockAlloyingFurnace extends BlockBase implements ITileEntityProvider {
	...
	public BlockAlloyingFurnace(String name) {
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) 
	{
		...
		if(active) worldIn.setBlockState(pos, BlockInit.ALLOYING_FURNACE.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(ACTIVE, true), 3);
		else worldIn.setBlockState(pos, BlockInit.ALLOYING_FURNACE.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(ACTIVE, false), 3);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityAlloyingFurnace();
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		TileEntityAlloyingFurnace tileentity = (TileEntityAlloyingFurnace)worldIn.getTileEntity(pos);
