...
public class GuiStaniumSmelter extends GuiContainer {
	...
	public GuiStaniumSmelter(InventoryPlayer player,TileEntityStaniumSmelter tileentity) {
		super(new ContainerStaniumSmelter(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if(TileEntityStaniumSmelter.isActive(tileentity)){
