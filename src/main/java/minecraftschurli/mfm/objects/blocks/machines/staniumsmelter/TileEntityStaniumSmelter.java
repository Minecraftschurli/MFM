...
public class TileEntityStaniumSmelter extends TileEntity implements IInventory, ITickable{
	...
	public String getName(){
		return this.hasCustomName() ? this.customName : "container.stanium_smelter";
	}
	...
	public void update() 
	{
		...
		if(this.isActive()) --this.burnTime;
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				BlockStaniumSmelter.setState(this.isActive(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = StaniumSmelterRecipes.getInstance().getStaniumSmelterResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = StaniumSmelterRecipes.getInstance().getStaniumSmelterResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
	...
	public static int getItemBurnTime(ItemStack fuel) 
	{
		...
		else 
		{
			...
			if(item instanceof ItemStanium)return item.getItemBurnTime(fuel);
