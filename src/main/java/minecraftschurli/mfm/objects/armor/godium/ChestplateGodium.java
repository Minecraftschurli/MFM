...
public class ChestplateGodium extends ArmorBase implements SetGodium 
{
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) 
	{
		...
		if(check==4)
		{
			player.addPotionEffect(new PotionEffect(Potion.getPotionById(11), 20, 4, false, false));
			player.addPotionEffect(new PotionEffect(Potion.getPotionById(23), 20, 0, false, false));
			player.addPotionEffect(new PotionEffect(Potion.getPotionById(16), 20, 4, false, false));
			player.addPotionEffect(new PotionEffect(Potion.getPotionById(13), 20, 0, false, false));
			player.addPotionEffect(new PotionEffect(Potion.getPotionById(5), 20, 4, false, false));
			player.addPotionEffect(new PotionEffect(Potion.getPotionById(12), 20, 0, false, false));
		}
	}
